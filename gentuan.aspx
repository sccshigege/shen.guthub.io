<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gentuan.aspx.cs" Inherits="gentuan" %>
					...
					<div class="col-md-9">
						...
						<div class="row clearfix">
							...
							<div class="col-md-6 col-sm-6 show_img">
								...
								<div class="words">
									<p class="words_title">【跟团游玩】景区的大标题代表提</p>
									<p class="words_main">跟团游玩跟团游玩跟团游玩跟团游玩的佩服个ikojaus送的肌肤介绍介绍介绍介绍</p>
							...
							<div class="col-md-6 col-sm-6 col-xs-12 show_img">
								...
								<div class="words">
									<p class="words_title">【跟团游玩】景区的大标题代表提</p>
									<p class="words_main">跟团游玩跟团游玩跟团游玩跟团游玩跟团游玩跟团游玩</p>
									<p class="words_price">￥299</p>
								</div>
								<div class="soldout">
									<p class="soldout_font">已售<span class="soldout_color">3115</span><span class="pull-right soldout_pj">666人已评价</span></p>
							...
							<div class="col-md-6 col-sm-6 show_img">
								...
								<div class="words">
									<p class="words_title">【跟团游玩】景区的大标题代表提</p>
									<p class="words_main">跟团游玩跟团游玩跟团游玩跟团游玩跟团游玩跟团游玩绍</p>
									<p class="words_price">￥299</p>
								</div>
								<div class="soldout">
									<p class="soldout_font">已售<span class="soldout_color">3115</span><span class="pull-right soldout_pj">666人已评价</span></p>
							...
							<div class="col-md-6 col-sm-6 show_img">
								...
								<div class="words">
									<p class="words_title">【跟团游玩】景区的大标题代表提</p>
									<p class="words_main">跟团游玩跟团游玩跟团游玩跟团游玩收跟跟团游玩ikojaus送的肌肤介绍介绍介绍介绍</p>
									<p class="words_price">￥299</p>
								</div>
								<div class="soldout">
									<p class="soldout_font">已售<span class="soldout_color">3115</span><span class="pull-right soldout_pj">666人已评价</span></p>
